...
func (server *Server) LoginUser(ctx context.Context, req *pb.LoginUserRequest) (*pb.LoginUserResponse, error) {
	violations := validateLoginData(req)
	if violations != nil {
...
func validateLoginData(req *pb.LoginUserRequest) (violations []*errdetails.BadRequest_FieldViolation) {
